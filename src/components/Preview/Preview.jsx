            ...
            <g className="d" transform="translate(-1093 -225)">
                <g transform="translate(1321.7 224.819)">
                    <g transform="translate(14.087)">
                        ...
                        <rect className="f" width="70.618" height="187.611"
                ...
                <g transform="translate(1175.7 502.819)">
                    <g transform="translate(14.087)">
                        ...
                        <path className="j" d="M569.246,70.93,517.6,119.941,615.622,175.8Z"
                    ...
                    <g className="y">
                        <g transform="translate(3689 716)">
                            ...
                            <g transform="translate(14 14.941)">
                                <rect className="aa" width="21.244" height="4.641" rx="2.32"
                                      transform="translate(0 13.922)"/>
                                <rect className="aa" width="16.227" height="4.641" rx="2.32"
                                      transform="translate(5.009)"/>
                                <rect className="aa" width="12.754" height="4.641" rx="2.32"
                                      transform="translate(13.122 6.961)"/>
                                <rect className="aa" width="9.281" height="4.641" rx="2.32"
